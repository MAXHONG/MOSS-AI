...
export const zhCN: Translations = {
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 MOSS AI 官方网站",
    githubTooltip: "访问 MOSS AI 的 Github 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 Github 上查看 MOSS AI",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 MOSS AI",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 MOSS AI 中使用",
  },
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 MOSS AI 的界面和行为。",
    sections: {
      appearance: "外观",
      memory: "记忆",
      tools: "工具",
    ...
    memory: {
      title: "记忆",
      description:
        "MOSS AI 会在后台不断从你的对话中自动学习。这些记忆能帮助 MOSS AI 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      markdown: {
        overview: "概览",
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 MOSS AI 根目录下的 `/skills/custom` 文件夹中。",
      emptyButton: "创建你的第一个技能",
    },
    notification: {
      title: "通知",
      description:
        "MOSS AI 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
