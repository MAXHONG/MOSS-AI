"""MOSS AIClient — Embedded Python client for MOSS AI agent system.

Provides direct programmatic access to MOSS AI's agent capabilities
...
class MOSS AIClient:
    """Embedded Python client for MOSS AI agent system.
