...
class InboundMessage:
    ...
    Attributes:
        ...
        topic_id: Conversation topic identifier used to map to a MOSS AI thread.
            Messages sharing the same ``topic_id`` within a ``chat_id`` will
            reuse the same MOSS AI thread.  When ``None``, each message
...
class OutboundMessage:
    ...
    Attributes:
        ...
        thread_id: MOSS AI thread ID that produced this response.
